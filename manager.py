...
while True:
    ...
    if a == 1:
        ...
        try:
            ...
            version = requests.get('https://raw.githubusercontent.com/bhumiharsaurabh/katil/main/version.txt')
        except:
        ...
        if float(version.text) > 0.9:
            ...
            if prompt == 'y' or prompt == 'yes' or prompt == 'Y':
                ...
                os.system('curl -l -O https://raw.githubusercontent.com/bhumiharsaurabh/katil/main/adder.py')
                os.system('curl -l -O https://raw.githubusercontent.com/bhumiharsaurabh/katil/main/manager.py')
